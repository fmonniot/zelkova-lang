...
| SPEC-31 | task | — | closed 2026-09-14 | A facade has no legitimate way to name `Int`, and `BUG-16` is what hides it — decided by DEC-15 |
...
| [SPEC-34](spec-34.md) | task | — | open | `Basics` declares three types the compiler already supplies |
