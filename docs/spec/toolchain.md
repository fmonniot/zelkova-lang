...
**Not implemented:** there is no runner. The compiler compiles both roots when it is asked
for a package's tests, and nothing then looks for a `Test` among what they hold.
